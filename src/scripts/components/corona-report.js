                                    ...
                                    <div class="container mt-5">
                                        <div class="row flex-column-reverse flex-lg-row">
                                            ...
                                            <div class="col-lg-4 text-white report text-center text-lg-left mt-3 my-lg-0 mb-4">
                                                <h3>Live Report</h3>
                                                <p class="text-white">
                                                    The number of cases that have occurred in Indonesia, the last update was ${dateUpdated.getDate()} ${monthNames[dateUpdated.getMonth()]} ${dateUpdated.getFullYear()}.
                                                </p>
                                            </div>
                                        </div>
                                    </div>`;
